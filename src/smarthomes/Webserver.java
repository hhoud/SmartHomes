...
public class Webserver extends Thread {
    ...
    private String ip = "192.168.137.89";
    ...
    //Pay attention, this is where things start to cook!
    try {
    ...
    //wait for buffers to empty before closing
    connectionsocket.setSoLinger(true, port);
    ...
    System.out.println("Header Line 1: " + tmp);
    ...
    //TODO: get Light Value, send to kinect
    EnvironmentVars.getInstance().setLightValue("iets");
